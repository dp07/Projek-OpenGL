...
glColor3f(1,0,0);
drawstring(450.0,700.0,0.0,"");
glColor3f(0.7,0,1);
drawstring(330,650,0.0,"");
glColor3f(1,0.5,0);
drawstring(530,600,0.0,"");
glColor3f(1,0,0);
drawstring(360,500,0.0,"");
glColor3f(1,0.5,0);
drawstring(200,400,0.0,"");
glColor3f(1,1,1);
drawstring(100,300,0.0,"");
glColor3f(1,1,1);
drawstring(100,240,0.0,"");
glColor3f(1,0.5,0);
...
glClear(GL_COLOR_BUFFER_BIT);
glColor3f(0,1,0);
drawstring(550.0,700.0,0.0,"Projek Grafkom ");
glColor3f(1,0,0);
drawstring(650.0,700.0,0.0,"");
glColor3f(0,0,1);
drawstring(750.0,700.0,0.0,"");
glColor3f(0.5,0.1,0.2);
drawstring(350.0,640.0,0.0,"Hentikan traffic (Lampu Merah) Klik kiri");
glColor3f(0.5,0.1,0.3);
drawstring(350.0,540.0,0.0,"lampu kuning klik kanan (tahan)");
glColor3f(0.5,0.1,0.4);
drawstring(350.0,440.0,0.0,"Lampu Hijau Klik Kanan (lepassskan)");
glColor3f(0.4,0.1,0.5);
drawstring(350.0,340.0,0.0,"");
glColor3f(0.5,0.1,0.6);
drawstring(350.0,240.0,0.0,"");
glColor3f(0.5,0.1,0.7);
drawstring(350.0,140.0,0.0,"Tambah kecepatan Tekan 'S'");
glColor3f(0.5,0.1,0.8);
drawstring(350.0,90.0,0.0, "Bantuan tekan 'H'");
glColor3f(0.5,0.1,0.9);
drawstring(350.0,40.0,0.0,"Keluar  'ENTER'");
glFlush();
}
...
glColor3f(0.0,0.0,0.0);
glBegin(GL_LINE_LOOP); //design a car
glVertex2f(8.0,3.0);
glVertex2f(16.0,3.0);
glVertex2f(16.5,3.5);
glVertex2f(17.0,4.0);
...
glBegin(GL_LINES); //outer line
glVertex2d(7.0,5.0);
glVertex2d(15.0,5.0);
glEnd();

glColor3f(0.0,0.0,0.0); //outer line
glBegin(GL_LINES);
glVertex2d(15.0,4.0);
glVertex2d(17.0,4.0);
glEnd();

glColor3f(0.0,0.0,0.0); //outer outer line
glBegin(GL_LINES);
glVertex2d(15.0,3.5);
glVertex2d(16.5,3.5);
glEnd();
